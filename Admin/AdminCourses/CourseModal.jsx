  ...
  return (
    <Modal isOpen={isOpen} size={'full'} onClose={handleClose} scrollBehavior='outside'>
        ...
        <ModalContent>
                    ...
                    <Box>
                        ...
                        <form onSubmit={e=>addLectureHandler(e,id,title,description,video)} >
                            ...
                            <VStack spacing={'4'}>
                                ...
                                <Input accept='video/mp4*' required id='chooseavatar' type='file' focusBorderColor='purple.400'
                                 css ={{ "&::file-selector-button" : {...fileUploadCss, color:'purple'}}} onChange={changeVideoHandler}
                                />
            ...
            <ModalFooter>
                <Button onClick={handleClose} colorScheme={'purple'} >Close</Button>
            </ModalFooter>
        </ModalContent>
